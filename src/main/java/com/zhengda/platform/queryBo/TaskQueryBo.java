...
public class TaskQueryBo extends BaseQueryBo {
    ...
    public void setProcessOrderNoSet(Set<String> processOrderNoSet) {
        put("processOrderNoSet", processOrderNoSet);
    }
    ...
    public void setOrderDetailIdSet(Set<Long> orderDetailIdSet) {
        put("orderDetailIdSet", orderDetailIdSet);
    }
